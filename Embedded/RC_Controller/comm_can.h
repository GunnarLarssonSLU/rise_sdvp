...
void comm_can_addio_print_val(int id, int data);
void comm_can_addio_print_help(float pos);
void comm_can_addio_set_valve_duty(float duty);
void comm_can_prop_valve_nmt_init();
void comm_can_prop_valve_activate();
