...
# Create a real AppImage for RControlStation
...
# Copy Qt libraries manually (since linuxdeployqt is too slow)
...
# Create AppImage using extract-and-run method (no FUSE needed)
echo "🛠️ Creating AppImage..."
./appimagetool --appimage-extract-and-run "$APP_DIR" "$FINAL_APPIMAGE"
